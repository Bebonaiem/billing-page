    ...
    <div class="flex">
        ...
        <aside class="fixed inset-y-0 left-0 z-50 w-64 glass-effect border-r border-custom">
            ...
            <nav class="mt-4">
                ...
                <div class="border-t border-custom mt-4 pt-4">
                    <a href="{{ route('admin.settings') }}" class="flex items-center px-6 py-3 text-secondary hover:bg-card/50 hover:text-white transition-all duration-200 rounded-lg mx-2">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.extensions.index') }}" class="flex items-center px-6 py-3 text-secondary hover:bg-card/50 hover:text-white transition-all duration-200 rounded-lg mx-2">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="ml-64 flex-1">
            ...
            <header class="glass-effect border-b border-custom">
                <div class="flex items-center justify-between px-8 py-4">
                    <h1 class="text-2xl font-bold accent-text">@yield('header', 'Dashboard')</h1>
                    <div class="flex items-center space-x-4">
                        <a href="{{ route('home') }}" target="_blank" class="accent-bg-hover text-white px-4 py-2 rounded-lg transition-all duration-200">
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit" class="bg-card/50 border border-custom text-secondary hover:text-white px-4 py-2 rounded-lg transition-all duration-200">
                                <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
